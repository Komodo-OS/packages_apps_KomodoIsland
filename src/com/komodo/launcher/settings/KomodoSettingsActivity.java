 ...
 */
package com.komodo.launcher.settings;
...
public class KomodoSettingsActivity extends SettingsActivity {

    public static final String MINUS_ONE_KEY = "pref_enable_minus_one";

    /**
     * This fragment shows the launcher komodo preferences.
     */
    public static class KomodoLauncherSettingsFragment extends LauncherSettingsFragment {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            for (int i = screen.getPreferenceCount() - 1; i >= 0; i--) {
                ...
                if (!initKomodoPreference(preference)) {
        ...
        protected boolean initKomodoPreference(Preference preference) {
