...
import com.komodo.launcher.qsb.QsbAnimationController;
import com.komodo.launcher.settings.KomodoSettingsActivity;
...
public class KomodoLauncherCallbacks implements LauncherCallbacks,
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        if (KomodoSettingsActivity.MINUS_ONE_KEY.equals(key)) {
    ...
    private ClientOptions getClientOptions(SharedPreferences prefs) {
        ...
        boolean isEnabled = prefs.getBoolean(KomodoSettingsActivity.MINUS_ONE_KEY, true);
